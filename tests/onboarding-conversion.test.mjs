...
assert.match(gmTurn,/progressiveChoices/);
assert.match(gmTurn,/modelChoicesAreFresh/);
assert.match(narrate,/minItems:3,maxItems:3/);
assert.match(narrate,/repeating the previous decision is no longer possible/);
