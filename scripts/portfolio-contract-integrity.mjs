...
const targets=[...Object.entries(manifest.schemas).map(([name,hash])=>[`../contracts/${name}`,hash]),['../server/services/generated/portfolio-contracts.js',manifest.generated['generated/javascript/validators.js']]];
...
console.log('Game Platform portfolio contract integrity: OK');
